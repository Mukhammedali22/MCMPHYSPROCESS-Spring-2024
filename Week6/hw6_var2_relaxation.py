...
P_3 = Over_Relaxation_method(P_old, P_new, N, M, dx, dy)
# First run
P_3N = Numba_Over_Relaxation_method(P_old, P_new, N, M, dx, dy)
# Other runs
P_3N = Numba_Over_Relaxation_method(P_old, P_new, N, M, dx, dy)
P_3N = Numba_Over_Relaxation_method(P_old, P_new, N, M, dx, dy)
P_3N = Numba_Over_Relaxation_method(P_old, P_new, N, M, dx, dy)
...
np.savetxt(f"{path}\\HW6_P2_py.txt", P_3N, fmt="%.6f", delimiter="\t")

plot_result(X, Y, P_3N, name="Gauss-Seidel method")
