...
lang = ["cpp", "py"][1]
print(lang)
X = np.loadtxt(f"Results\\HW13_X_{lang}.txt")
Y = np.loadtxt(f"Results\\HW13_Y_{lang}.txt")
U = np.loadtxt(f"Results\\HW13_U_{lang}.txt")
V = np.loadtxt(f"Results\\HW13_V_{lang}.txt")
P = np.loadtxt(f"Results\\HW13_P_{lang}.txt")
UV = (U**2 + V**2)**0.5
