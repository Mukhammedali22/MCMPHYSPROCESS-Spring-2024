...
@timeit
def Alternating_direction_method(U:np.ndarray, N, M, dx, dy, dt, 
                           a2=1, eps=1e-6, stop_iteration=3e4):
    """Alternating direction method for solving 2D Heat equation"""
    U_old = U.copy()
...
@timeit
@jit(nopython=True)
def Numba_Alternating_direction_method(U:np.ndarray, N, M, dx, dy, dt, 
                           a2=1, eps=1e-6, stop_iteration=3e4):
    """Boosted Alternating direction method for solving 2D Heat equation"""
    U_old = U.copy()
    U_new = np.zeros_like(U)
...
U_1 = Alternating_direction_method(U_old, N, M, dx, dy, dt, a2=a2)

U_1N = Numba_Alternating_direction_method(U_old, N, M, dx, dy, dt, a2=a2)
U_1N = Numba_Alternating_direction_method(U_old, N, M, dx, dy, dt, a2=a2)
U_1N = Numba_Alternating_direction_method(U_old, N, M, dx, dy, dt, a2=a2)
U_1N = Numba_Alternating_direction_method(U_old, N, M, dx, dy, dt, a2=a2)
U_1N = Numba_Alternating_direction_method(U_old, N, M, dx, dy, dt, a2=a2)
...
plot_result(X, Y, U_1, name="Alternating direction method")
plot_result(X, Y, U_1N, name="Alternating direction method")
